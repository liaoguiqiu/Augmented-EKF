...
%   load(dir_mat_files(5).name) %????????????3
  load('my_high_dynamic.mat');
%  load('UavData_5_100hz.mat');
catch
...
% state_estimation_method =5;
state_estimation_method =6;
switch state_estimation_method
    ...
    case 6
        perform_state_estimation__ins_ekf_quaternion_with_time_error
    otherwise
