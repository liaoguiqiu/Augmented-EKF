...
load('UavData_LetterE_my_est_save_well_time6_23.mat');
load('UavData_LetterE_uavsensor_well_time6_23.mat');
load('UavData_LetterE_100hz.mat');
% load('my_est_save_paper_method.mat');
% load('uavSensors_paper_method.mat');
% load('uavTruth_paper_method.mat');
% my_est_save = my_est_save_paper_method;
% uavSensors  = uavSensors_paper_method;
% uavTruth = uavTruth_paper_method;
my_est_save = my_est_save_well_time6_23;
uavSensors  = uavsensor_well_time6_23;
load('fir_b.mat');
save_old_acc_length=7000;
kf_fuse_init;
