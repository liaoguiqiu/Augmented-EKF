...
LENG = length( uavTruth.pitch_deg);
plot(   uavTruth.pitch_deg(1:10:LENG),'r-','markersize',6, 'linewidth', 2);hold on;grid on;
plot(   uavEst_well_result .pitch_deg(1:10:LENG),'b. ','markersize',6, 'linewidth', 1.1);hold on;grid on; 
plot(   uavEst_100ms_lag.pitch_deg(1:10:LENG),  'g. ','markersize',6, 'linewidth', 1.1);hold on;grid on; 
% Label figure
grid on;
axis([1  3000 -20 30]);  %显示范围
...
hold off;
% plot(my_est_save.kalman_y_v_est,estimateLineType,'markersize',markerSize, 'linewidth', linewidth);hold on;grid on;
plot(   uavTruth.pitch_deg(10000:10:LENG),'r-','markersize',6, 'linewidth', 2);hold on;grid on;
plot(   uavEst_well_result .pitch_deg(10000:10:LENG),'b--. ','markersize',6, 'linewidth', 2);hold on;grid on; 
plot(   uavEst_100ms_lag.pitch_deg(10000:10:LENG),  'g--. ','markersize',6, 'linewidth', 1.1);hold on;grid on; 
% Label figure
grid on;
axis([1  3000 -20 30]);  %显示范围
lengend_size=legend('Model','Fuse alignment','EKF directly');
...
hold off;
% plot(my_est_save.kalman_y_v_est,estimateLineType,'markersize',markerSize, 'linewidth', linewidth);hold on;grid on;
plot(   uavTruth.roll_deg(10000:10:LENG),'r-','markersize',6, 'linewidth', 3);hold on;grid on;
plot(   uavEst_well_result .roll_deg(10000:10:LENG),'b--. ','markersize',6, 'linewidth', 2);hold on;grid on; 
plot(   uavEst_200ms_lag.roll_deg(10000:10:LENG),  'g--. ','markersize',6, 'linewidth', 1.1);hold on;grid on; 
% Label figure
grid on;
axis([1  3000 -30 30]);  %显示范围
lengend_size=legend('Model','Fuse alignment','EKF directly');
set(lengend_size,'Fontsize',12);
set(gca, 'GridLineStyle', '--','FontName','Times New Roman','FontSize',12,'LineWidth',1);%网格类型
xlabel('Time(0.1s)','FontName','Times New Roman','FontSize',12)
...
wrap = @(angleDeg)(mod(angleDeg+180,360)-180); % Wrap from -180deg to 180deg.
% plot(my_est_save.kalman_y_v_est,estimateLineType,'markersize',markerSize, 'linewidth', linewidth);hold on;grid on;
plot(  wrap( uavTruth.yaw_deg(10000:10:LENG)),'r-','markersize',6, 'linewidth', 3);hold on;grid on;
plot(  wrap( uavEst_well_result .yaw_deg(10000:10:LENG)),'b--. ','markersize',6, 'linewidth', 2);hold on;grid on; 
plot(   wrap(uavEst_100ms_lag.yaw_deg(10000:10:LENG)),  'g--. ','markersize',6, 'linewidth', 1.1);hold on;grid on; 
% Label figure
grid on;
 axis([1  3000 -180 180]);  %显示范围
lengend_size=legend('Model','Fuse alignment','EKF directly');
set(lengend_size,'Fontsize',12);
set(gca, 'GridLineStyle', '--','FontName','Times New Roman','FontSize',12,'LineWidth',1);%网格类型
xlabel('Time(0.1s)','FontName','Times New Roman','FontSize',12)
